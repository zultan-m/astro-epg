...
"Nick-Jr-392","Moonbug-465","Blippi-and-Friends-566","AXN-HD-131",
"HITS-NOW-524","Lifetime-HD-447","HITS-HD-179","TLC-HD-338","Asian-Food-Network-HD-91",
"Crime-and-Investigation-HD-369","HGTV-HD-198","Astro-Arena-235",
...
def generate_epg():
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        ...
        # Simpan ikut slug
        future_map = {
            slug: executor.submit(process_slug, build_id, slug)
            for slug in CHANNEL_SLUGS
        }

        # Ambil ikut susunan asal CHANNEL_SLUGS
        for slug in CHANNEL_SLUGS:
            future = future_map[slug]
